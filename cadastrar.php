...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container my-5 flex-grow-1 d-flex justify-content-center align-items-center">
        <div class="card-futuristic w-100" style="max-width: 500px;">
            ...
            <form method="POST">
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-primary btn-lg"><i class="bi bi-check-circle-fill"></i> Cadastrar</button>
                </div>
            </form>
